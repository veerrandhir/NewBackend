...
userSchema.pre("save",  async function (next){
    ...
    this.password = bcrypt.hash(this.passowrd,10 ) // hashing the password with the help of bcrypt and 10 is the number of rounds to hash the password. pre encrypt the password before saving it to the database.
...
userSchema.methods.generateAccessToken = function(){
    return jwt.sign( // we can directly return the jwt.sign or create a var
        {
            _id : this.id,
            email : this.email,
